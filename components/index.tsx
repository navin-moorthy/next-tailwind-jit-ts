...
import { Button, CircularProgress, CircularProgressProps } from "@renderlesskit/react-tailwind";

export type CircularProgressBasicProps = CircularProgressProps & {};

export const CircularProgressBasic: React.FC<CircularProgressBasicProps> = (props) => {
